  ...
  switch (ul_dcch_msg.msg.c1().type().value) {
    ...
    case ul_dcch_msg_type_c::c1_c_::types_opts::ue_cap_info:
      if (otabase_waiting_for_rrc_oracle) {
        // Oracle response — UE is alive; stop timer and resume testing.
        logger.log_info("OTABase: received UECapInfo oracle response");
        ...
        otabase_rrc_oracle_cnt         = 0;
        maybe_send_next_otabase_rrc_message("oracle_ok");
      } else {
